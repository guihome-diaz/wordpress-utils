...
public class WpRoles implements Serializable {
    ...
    public final static WpRole SUBSCRIBER
            = new WpRole("Subscriber", Set.of(WpCapability.read));

    /** Contributor (slug: ‘contributor’) – somebody who can write and manage their own posts but cannot publish them. */
    public final static WpRole CONTRIBUTOR
            = new WpRole("Contributor", SUBSCRIBER.getCapabilities(), Set.of(WpCapability.edit_posts, WpCapability.delete_posts));

    /** Author  (slug: ‘author’)  – somebody who can publish and manage their own posts. */
    public final static WpRole AUTHOR = new WpRole("Author",
             CONTRIBUTOR.getCapabilities(),
    ...
    public final static WpRole EDITOR = new WpRole("Editor",
            AUTHOR.getCapabilities(),
    ...
    public final static WpRole ADMINISTRATOR = new WpRole("Administrator",
    ...
    public final static WpRole SUPER_ADMIN = new WpRole("Super Admin",
            ADMINISTRATOR.getCapabilities(),
